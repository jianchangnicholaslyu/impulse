...
module.exports = function authMagicLink(payload = {}) {
  ...
  const subject = "Sign in to IMPULSE";
  const text = textFromLines([
    "Use the secure link below to sign in to IMPULSE.",
    magicLink,
    `This link expires in ${expiresInMinutes} minutes.`
  ]);
  const html = renderEmail({
    title: "Sign in to IMPULSE",
    preheader: "Your secure IMPULSE sign-in link.",
    intro: [
      "Use this secure link to sign in to your IMPULSE account.",
